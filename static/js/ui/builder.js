...
!(function (G) {
  const U = G.Utils,
    ...
    I = {
      ...
      eraser:
        '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M15.14 3c-.51 0-1.02.2-1.41.59L2.59 14.73a2 2 0 000 2.83l2.58 2.61a2 2 0 002.83 0L19.14 9.03a2 2 0 000-2.83L16.55 3.59A2 2 0 0015.14 3z"/></svg>',
      ...
      eyedrop:
        '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M20.71 5.63l-2.34-2.34a1 1 0 00-1.41 0l-3.12 3.12-1.71-1.71-1.41 1.41 1 1L4 14.83V20h5.17l7.72-7.72 1 1 1.41-1.41-1.71-1.71 3.12-3.12a1 1 0 000-1.41z"/></svg>',
      pixel:
        '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M3 3h4v4H3zm7 0h4v4h-4zm7 0h4v4h-4zM3 10h4v4H3zm7 0h4v4h-4zM3 17h4v4H3z"/></svg>',
      ...
      select:
        '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-dasharray="4 3"><rect x="3" y="3" width="18" height="18" rx="1"/></svg>',
      lasso:
        '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 12a5 5 0 10-5 5"/><circle cx="12" cy="17" r="2" fill="currentColor"/></svg>',
      ...
      first:
        '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M18 18l-8.5-6L18 6v12zM8 6H6v12h2z"/></svg>',
      ...
      timeline:
        '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M4 6H2v14a2 2 0 002 2h14v-2H4V6zm16-4H8a2 2 0 00-2 2v12a2 2 0 002 2h12a2 2 0 002-2V4a2 2 0 00-2-2zm-8 12.5v-9l6 4.5-6 4.5z"/></svg>',
      ...
      merge:
        '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M6 6h12v2H6zm0 4h12v2H6zm0 4h12v2H6z"/></svg>',
      onion:
        '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="10" cy="12" r="6" opacity=".4"/><circle cx="14" cy="12" r="6"/></svg>',
      ...
      ratio:
        '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="5" width="18" height="14" rx="2"/><path d="M3 12h18"/></svg>',
      rotate:
        '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M7.11 8.53L5.7 7.11C4.8 8.27 4.24 9.61 4.07 11h2.02c.14-.87.49-1.72 1.02-2.47zM6.09 13H4.07c.17 1.39.72 2.73 1.62 3.89l1.41-1.42c-.52-.75-.87-1.59-1.01-2.47zM7.1 18.32c1.16.9 2.51 1.44 3.9 1.61V17.9c-.87-.15-1.71-.49-2.46-1.03L7.1 18.32zM13 4.07V1L8.45 5.55 13 10V6.09c2.84.48 5 2.94 5 5.91s-2.16 5.43-5 5.91v2.02c3.95-.49 7-3.85 7-7.93s-3.05-7.44-7-7.93z"/></svg>',
      flipH:
      ...
      flipV:
        '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M3 15v2h2v-2H3zm12 4v2h2v-2h-2zM5 21c0 1.1.9 2 2 2v-2H5zm14-4v2h2v-2h-2zM5 15v2h2v-2H5zM1 11v2h22v-2H1zm18-4v2h2V7h-2zM5 3v2h2V3H5zm14 0c1.1 0 2 .9 2 2h-2V3zM9 3v2h2V3H9zm4 0v2h2V3h-2z"/></svg>',
      audio:
      ...
      symmetry:
        '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 3v18M5 7l7 5-7 5M19 7l-7 5 7 5"/></svg>',
      zoomIn:
        '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M15.5 14h-.79l-.28-.27A6.47 6.47 0 0016 9.5 6.5 6.5 0 109.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14zM12 10h-2v2H9v-2H7V9h2V7h1v2h2v1z"/></svg>',
      zoomOut:
        '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M15.5 14h-.79l-.28-.27A6.47 6.47 0 0016 9.5 6.5 6.5 0 109.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14zM7 9h5v1H7V9z"/></svg>',
      ...
      zoomSel:
        '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M15.5 14h-.79l-.28-.27A6.47 6.47 0 0016 9.5 6.5 6.5 0 109.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/><rect x="7" y="7" width="5" height="5" rx=".5" fill="none" stroke="currentColor" stroke-width="1.5" stroke-dasharray="2 1.5"/></svg>',
      layers:
        '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M11.99 18.54l-7.37-5.73L3 14.07l9 7 9-7-1.63-1.27-7.38 5.74zM12 16l7.36-5.73L21 9l-9-7-9 7 1.63 1.27L12 16z"/></svg>',
      ...
      addMany:
        '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M3 13h2v-2H3v2zm0 4h2v-2H3v2zm2 4v-2H3c0 1.1.9 2 2 2zM3 9h2V7H3v2zm12 12h2v-2h-2v2zm4-18H9c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 12H9V5h10v10zm-8 6h2v-2h-2v2zm-4 0h2v-2H7v2z"/></svg>',
  ...
  function buildColorGrid() {
    const cg = U.$("colorGrid");
    C.COLORS.forEach((c) => {
      const d = document.createElement("div");
      ((d.className = "color-swatch" + (c === S.cc ? " on" : "")),
        (d.style.background = c),
        "#FFFFFF" === c && (d.style.border = "2px solid #999"),
        (d.dataset.c = c),
        (d.onclick = () => {
          ((S.cc = c), buildColorGrid(), buildQuickColors());
        }),
        cg.appendChild(d));
    });
  }
  function buildSizeRow() {
    const sr = U.$("sizeRow");
    [1, 2, 4, 8, 16, 32, 64].forEach((s) => {
      const d = document.createElement("div");
      ((d.className = "size-dot" + (s === S.cs ? " on" : "")),
        (d.dataset.size = s));
      const px = Math.max(6, Math.min(28, 1.5 * s + 4));
      ((d.style.width = px + "px"),
        (d.style.height = px + "px"),
        (d.onclick = () => {
          ((S.cs = s), buildSizeRow(), buildQuickSizes());
        }),
        sr.appendChild(d));
    });
  }
  function buildPaperGrid() {
    const pg = U.$("paperGrid");
    C.PAPER_COLORS.forEach((c) => {
      const d = document.createElement("div");
      ((d.className = "paper-opt" + (c === S.pc ? " on" : "")),
        (d.style.background = c),
        (d.dataset.p = c),
        (d.onclick = () => {
          ((S.pc = c), E.updatePaperColor(), buildPaperGrid());
        }),
        pg.appendChild(d));
    });
  }
  function buildQuickColors() {
    const qc = U.$("colorQuick");
    ((qc.innerHTML = ""),
      [
        "#111111",
        "#E02020",
        ...
        const d = document.createElement("div");
        ((d.className = "qc" + (c === S.cc ? " on" : "")),
          (d.style.background = c),
          "#FFFFFF" === c && (d.style.border = "1.5px solid #888"),
          (d.dataset.c = c),
          (d.onclick = () => {
            ((S.cc = c), buildQuickColors(), buildColorGrid());
          }),
          qc.appendChild(d));
      }));
  }
  function buildQuickSizes() {
    const qs = U.$("sizeQuick");
    ((qs.innerHTML = ""),
      [2, 4, 8, 16].forEach((s) => {
        const d = document.createElement("div");
        ((d.className = "qs" + (s === S.cs ? " on" : "")),
          (d.dataset.size = s));
        const px = Math.max(5, Math.min(16, s + 4));
        ((d.style.width = px + "px"),
          (d.style.height = px + "px"),
          (d.onclick = () => {
            ((S.cs = s), buildQuickSizes(), buildSizeRow());
          }),
          qs.appendChild(d));
      }));
  }
  ((UI.showPage = (page) => {
    ((S.currentPage = page),
      ["canvasPage", "menuPage", "timelinePage"].forEach((id) => {
        const el = U.$(id);
        el && el.classList.toggle("active", id === page + "Page");
      }),
      ...
      ((U.$("app").innerHTML =
        ...
        (function () {
          ...
          C.RATIOS.forEach((r) => {
            ...
            let vw, vh;
            (aspect > 1
              ? ((vw = maxSz), (vh = maxSz / aspect))
              : ((vh = maxSz), (vw = maxSz * aspect)),
              (d.innerHTML = `<div class="rv" style="width:${vw}px;height:${vh}px"></div><span>${r.name}</span>`),
              (d.onclick = () => {
                S._pendingRatio = r;
                U.$("ratioModal").classList.remove("show");
                U.$("ratioConfirmModal").classList.add("show");
              }),
              rg.appendChild(d));
          });
        })(),
        ...
        (function () {
          if (!G.Audio) return;
          const sel = U.$("sfxSelect");
          G.Audio.getSFXList().forEach((name) => {
    ...
    (UI.openMixer = () => {
      (U.$("mixerModal").classList.add("show"),
        UI.renderMixerGrid(),
        S.seNames.forEach((n, i) => {
          const el = U.$(`seName${i}`);
          el && (el.textContent = S.seBuffers[i] ? n : "デフォルト");
        }));
      const bgmName = U.$("mixBgmName");
      bgmName && (bgmName.textContent = A.bgmBuffer ? "設定済み" : "なし");
    }),
    (UI.renderMixerGrid = () => {
      ...
      ((head.style.width = gridWidth + "px"),
        ...
        S.frames.forEach((_, i) => {
          ...
          ((n.className = "se-grid-num " + (i === S.cf ? "cur" : "")),
            (n.textContent = i + 1),
            (n.onclick = () => {
              (TL.switchFrame(i), UI.renderMixerGrid());
            }),
            head.appendChild(n));
        }));
      for (let ch = 0; ch < 4; ch++)
        S.frames.forEach((fr, f) => {
          const cell = document.createElement("div"),
            isActive = fr.seFlags && fr.seFlags[ch],
            chClass = `ch${ch}`;
          ((cell.className = `se-cell ${isActive ? "on" : ""} ${chClass}`),
            isActive && (cell.innerHTML = I.note),
            (cell.onclick = () => {
              (fr.seFlags || (fr.seFlags = [0, 0, 0, 0]),
              ...
              (cell.classList.toggle("on", nowActive),
                ...
                nowActive && A.playSEChannel(ch));
            }),
            body.appendChild(cell));
        });
      const sx = Math.max(0, 24 * S.cf - 100);
      ...
      (U.$$(".se-mic").forEach((b) => {
        b.onclick = async () => {
          (b.classList.add("active"),
            await A.recordToChannel(+b.dataset.ch),
            b.classList.remove("active"),
            (U.$(`seName${b.dataset.ch}`).textContent =
              S.seNames[b.dataset.ch]));
        };
      }),
        U.$$(".se-play").forEach(
          (b) => (b.onclick = () => A.playSEChannel(+b.dataset.ch)),
        ),
        U.$$(".se-clear").forEach(
          (b) =>
          (b.onclick = () => {
            (A.clearChannel(+b.dataset.ch),
              (U.$(`seName${b.dataset.ch}`).textContent = "デフォルト"));
          }),
        ),
        U.$$(".se-file-in").forEach(
          (i) =>
          (i.onchange = async (e) => {
            const f = e.target.files[0];
            f &&
              ((await A.importToChannel(+i.dataset.ch, f)) &&
                (U.$(`seName${i.dataset.ch}`).textContent =
                  S.seNames[i.dataset.ch]),
                (i.value = ""));
          }),
        ));
      const bgmIn = U.$("mixBgmIn");
      (bgmIn &&
        (bgmIn.onchange = (e) => {
          const f = e.target.files[0];
          (f &&
            A.loadBGM(f).then(() => (U.$("mixBgmName").textContent = "設定済")),
            (bgmIn.value = ""));
        }),
        (U.$("mixBgmClear").onclick = () => {
          (A.clearBGM(), (U.$("mixBgmName").textContent = "なし"));
        }));
    }),
    (UI.buildLayerList = () => {
      const el = U.$("layerList");
      if (!el) return;
      ((el.innerHTML = ""),
        S.layerOrder
          .slice()
          ...
          .forEach((l) => {
            ...
            const vis = document.createElement("div"),
              rc = R.getRasterCanvas(l),
              vc = R.getVectorCanvas(l),
              isVis = rc && "none" !== rc.style.display;
            ((vis.className = "layer-vis" + (isVis ? " on" : "")),
              (vis.innerHTML = isVis ? I.eye : I.eye_off),
              (vis.onclick = (e) => {
                e.stopPropagation();
                const newDisp = "none" === rc.style.display ? "block" : "none";
                ((rc.style.display = newDisp),
                  vc && (vc.style.display = newDisp),
                  (vis.className =
                    "layer-vis" + ("none" !== newDisp ? " on" : "")),
                  (vis.innerHTML = "none" !== newDisp ? I.eye : I.eye_off));
              }),
              d.appendChild(vis));
            const sp = document.createElement("span");
            ((sp.textContent = l), d.appendChild(sp));
            const acts = document.createElement("div");
            ((acts.className = "layer-acts"),
              [
                { icon: I.up, dir: 1 },
                { icon: I.down, dir: -1 },
              ].forEach(({ icon: icon, dir: dir }) => {
                ...
                ((b.className = "mini-btn"),
                  ...
                  (b.onclick = (e) => {
                    e.stopPropagation();
                    const idx = S.layerOrder.indexOf(l);
                    1 === dir && idx < S.layerOrder.length - 1
                      ? (([S.layerOrder[idx], S.layerOrder[idx + 1]] = [
                        S.layerOrder[idx + 1],
                        S.layerOrder[idx],
                      ]),
                        E.updateLayerZOrder(),
              ...
              d.appendChild(acts),
              (d.onclick = () => {
                ((S.cl = l), UI.buildLayerList());
              }),
              el.appendChild(d));
          }));
      const pd = document.createElement("div");
      pd.className = "layer-row photo" + ("Photo" === S.cl ? " on" : "");
      const pv = document.createElement("div");
      ((pv.className =
        "layer-vis" +
        (R.canvases.lPhoto && "none" !== R.canvases.lPhoto.style.display
          ? " on"
          : "")),
        (pv.innerHTML =
          R.canvases.lPhoto && "none" !== R.canvases.lPhoto.style.display
        ...
        (pv.onclick = (e) => {
          (e.stopPropagation(),
            (R.canvases.lPhoto.style.display =
              "none" === R.canvases.lPhoto.style.display ? "block" : "none"),
            pv.classList.toggle("on"),
            (pv.innerHTML =
              "none" !== R.canvases.lPhoto.style.display ? I.eye : I.eye_off));
        }),
        pd.appendChild(pv));
      ...
      ((ps2.textContent = "写真"),
        pd.appendChild(ps2),
        (pd.onclick = () => {
          ((S.cl = "Photo"), UI.buildLayerList());
        }),
        el.appendChild(pd));
    }),
    (UI.updateFrameInfo = () => {
      (["curF", "curF2"].forEach((id) => {
        const el = U.$(id);
        el && (el.textContent = S.cf + 1);
      }),
        ["totF", "totF2"].forEach((id) => {
          const el = U.$(id);
          el && (el.textContent = S.frames.length);
        }));
      const fill = U.$("scrubFill");
      fill &&
        (fill.style.width =
          (S.frames.length > 1 ? (S.cf / (S.frames.length - 1)) * 100 : 0) +
          "%");
      const se = U.$("scrubEnd");
      se && (se.textContent = S.frames.length);
      const ss = U.$("scrubStart");
      ss && (ss.textContent = S.cf + 1);
      const pv = U.$("tlPreviewCanvas");
      if (
        pv &&
        G.Export &&
        G.Export.renderFrameToCtx &&
        "timeline" === S.currentPage
      ) {
        const ctx = pv.getContext("2d");
        const ratioX = pv.width / S.CW;
        const ratioY = pv.height / S.CH;
        const scale = Math.min(ratioX, ratioY);
        const pw = S.CW * scale;
        const ph = S.CH * scale;
        const dx = (pv.width - pw) / 2;
        const dy = (pv.height - ph) / 2;
    ...
    (UI.initScrubber = () => {
      ...
      const seek = (e) => {
        const rect = track.getBoundingClientRect(),
          ...
          frame = Math.round(ratio * (S.frames.length - 1));
        frame !== S.cf && G.Timeline && G.Timeline.switchFrame(frame);
      };
      let scrubbing = !1;
      (track.addEventListener("pointerdown", (e) => {
        ((scrubbing = !0), track.setPointerCapture(e.pointerId), seek(e));
      }),
    ...
    (UI.initLoopToggle = () => {
      const btn = U.$("loopToggle");
      btn &&
        (btn.onclick = () => {
          ((S.loopPlay = !S.loopPlay),
            btn.classList.toggle("on", S.loopPlay),
            E.toast(S.loopPlay ? "ループ ON" : "ループ OFF"));
        });
    }),
    (UI.showSelZoomBtn = (show) => {
      const btn = U.$("selZoomBtn");
      btn && btn.classList.toggle("show", show);
    }),
    (UI.zoomToSelection = () => { }),
    (G.UI = UI));
})(window.UgokuDraw);
